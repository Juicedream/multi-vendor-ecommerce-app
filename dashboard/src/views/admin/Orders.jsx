    ...
    <div className="px-2 lg:px-7 pt-5">
      <div className="w-full p-4 bg-[#6a5fdf] rounded-md">
        ...
        <div className="relative mt-5 overflow-x-auto">
          <div className="w-full text-sm text-left bg-[#6a5fdf] text-[#d0d2d6]">
            ...
            <div className="text-[#d0d2d6]">
              <div className="flex justify-between items-start border-b border-slate-700">
                ...
                <div className="py-3 w-[13%] font-medium">$512</div>
                ...
                <div
                  ...
                  className="py-3 w-[8%] font-medium cursor-pointer duration-2000 transition-all"
                >
                  {show ? <LuSquareArrowUp /> : <LuSquareArrowDown />}
                </div>
              </div>
              <div
                className={
