    ...
    <div className="px-2 lg:px-7 pt-5">
      <div className="flex lg:hidden justify-between items-center mb-5 p-4 bg-[#6a5fdf] rounded-md">
        ...
        <button
          ...
          className="bg-red-500 shadow-lg hover:shadow-red-500/50 px-4 py-2 cursor-pointer text-white rounded-sm text-sm"
        >
          Add
        </button>
      </div>
          ...
          <div className="w-full pl-5">
            <div className="bg-[#6a5fdf] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]">
              <div className="flex mb-4">
                <h1 className="text-[#d0d2d6] font-semibold text-xl mb-4 text-center flex-1">
                  Add Category
                </h1>
                <div 
                 onClick={() => setShow(false)}
                 className="block lg:hidden mt-2 cursor-pointer"
              ...
              <form className="">
                ...
                <div>
                  <label
                    className="flex justify-center items-center flex-col h-[238px] w-full cursor-pointer border border-dashed hover:border-red-500 border-[#d0d2d6]"
                    htmlFor="image"
                  >
                    <span>
                      <FaImage />
                  ...
                  />
                  <div>
                    <button className="bg-red-500 w-full hover:shadow-red-500/40 hover:shadow-md text-white rounded-md px-7 py-2 my-2 cursor-pointer">
                      Add Category
                    </button>
                  </div>
                </div>
